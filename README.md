...
- **Framer Motion**: Engine de animações para transições suaves e efeitos de scroll.
- **Lucide React**: Biblioteca de ícones vetoriais.
- **GitHub API**: Integração para busca dinâmica de repositórios em tempo real.
...
- **UX/UI Moderno**: Implementação de modal lightbox para visualização de imagens, menus interativos e efeitos de brilho dinâmico.
- **Foco em Negócio**: Seção dedicada à metodologia de trabalho (Scrum/ClickUp), demonstrando maturidade além do código.
...
git clone https://github.com/MAC-2006/meu-portfolio.git
